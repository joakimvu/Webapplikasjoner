...
CREATE TABLE "_FeedToFeedTag" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
    CONSTRAINT "_FeedToFeedTag_A_fkey" FOREIGN KEY ("A") REFERENCES "feeds" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_FeedToFeedTag_B_fkey" FOREIGN KEY ("B") REFERENCES "feed_tags" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
